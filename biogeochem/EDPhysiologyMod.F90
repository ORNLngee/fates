...
contains
  ...
  subroutine phenology( currentSite, bc_in )
    ...
    ! Junyan Ding: modified to adding nevercold
    ...
    if( (currentSite%cstatus == phen_cstat_notcold)  .and. &
        (currentSite%cndaysleafoff > 40000)) then   ! remove leaves after a whole year,
                                                   ! Junyan Ding: change dayssincecleafoff > 400 to 40000 to disable this function, so the condition will never be met
