module LeafBiophysicsMod
  ...
  ! Junyan Ding added
  ! Parameter of Vcmax reduction function by salinity
  ...
  type, public :: leafbiophys_params_type
     ...
     real(r8),allocatable :: gs_min(:)                            ! Stomatal min. for stoma mode 5 [-] (Junyan Ding added)
     real(r8),allocatable :: gs_max(:)                            ! Stomatal max. for stoma mode 5 [-] (Junyan Ding added)
...
contains
  ...
  subroutine LeafLayerBiophysicalRates( ft,            &
    ...
    ! Junyan Ding added: adjust Vcmax by salinity using a signomal equation,
