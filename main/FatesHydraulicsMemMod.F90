module FatesHydraulicsMemMod
   ...
   ! Junyan Ding added: used to initial the h2osoil_th_mem array, (nlevelsoi, int (num_days_soilth_mem*day_to_second/dtime) )
  ...
  type, public :: ed_cohort_hydr_type
     ...
     ! Junyan Ding added
     ! Diagnostic, osmotic potential and salt concentration of each plant compartments
